...
const accentMap: Record<Accent, { bg: string; text: string }> = {
  indigo: { bg: "bg-indigo-400/10", text: "text-indigo-700" },
  emerald: { bg: "bg-emerald-400/10", text: "text-emerald-700" },
  amber: { bg: "bg-amber-400/10", text: "text-amber-800" },
  violet: { bg: "bg-violet-400/10", text: "text-violet-700" },
  cyan: { bg: "bg-cyan-400/10", text: "text-cyan-700" },
  rose: { bg: "bg-rose-400/10", text: "text-rose-700" },
};
...
export function KpiCard({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="text-sm text-os-subtle uppercase tracking-wider">{label}</span>
      ...
      <div className="flex items-center gap-2 min-h-[18px]">
        {change !== undefined && (
          <span className={cn("flex items-center gap-1 text-xs", change >= 0 ? "text-emerald-700" : "text-rose-700")}>
