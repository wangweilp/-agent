...
const navItems = [
  ...
  { href: "/agents", label: "Internal Agent Center", icon: Bot },
  { href: "/agent-marketplace", label: "Agent Marketplace", icon: ShoppingBag },
  { href: "/developer", label: "Developer Console", icon: Code2 },
  { href: "/admin/agent-submissions", label: "Agent Review", icon: ShieldCheck },
  { href: "/admin/runtime", label: "Runtime Admin", icon: ServerCog },
